...
ALLOWED_HOSTS = ['redux_saga_workshop.TEST.TODO.com']

# Static site url, used when we need absolute url but lack request object, e.g. in email sending.
SITE_URL = 'https://redux_saga_workshop.TEST.TODO.com'
...
LOGGING['handlers'] = {
    'info_log': {
        ...
        'filename': '/var/log/redux_saga_workshop/info.log',
        'formatter': 'default',
    },
    'error_log': {
        'level': 'ERROR',
        'class': 'logging.handlers.WatchedFileHandler',
        'filename': '/var/log/redux_saga_workshop/error.log',
        'formatter': 'default',
    },
    'sentry': {
        'level': 'ERROR',
