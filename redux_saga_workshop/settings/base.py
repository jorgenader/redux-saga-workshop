"""
Django settings for Redux-Saga Workshop project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = '[Redux-Saga Workshop] '  # subject prefix for managers & admins

SESSION_COOKIE_NAME = 'redux_saga_workshop_ssid'
...
REDIS_HOST = 'redis_redux_saga_workshop'
REDIS_PORT = 6379
REDIS_DB = 1
...
ROOT_URLCONF = 'redux_saga_workshop.urls'

WSGI_APPLICATION = 'redux_saga_workshop.wsgi.application'
...
# Email config
DEFAULT_FROM_EMAIL = "Redux-Saga Workshop <info@TODO.com>"
SERVER_EMAIL = "Redux-Saga Workshop server <server@TODO.com>"
